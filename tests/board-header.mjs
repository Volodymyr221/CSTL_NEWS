...
// ℹ️ РЕЖИМ «В ПОТОЦІ» (06.08) ТУТ НЕ ПЕРЕВІРЯЄТЬСЯ, і це свідомо.
// Ця сцена — синтетична (`setContent`), у ній немає ані `bundle.js`, ані
// `setupHeaderCollapse`, тобто вмикати режим нема кому. Перевірка «в потоці»
// на такій сцені могла б лише вручну поставити клас і зміряти CSS — тобто
// доводила б, що CSS написаний, а не що ПОВЕДІНКА працює.
// ➡️ Живий сторож режиму — `tests/board-header-flow.mjs` (справжній застосунок).
