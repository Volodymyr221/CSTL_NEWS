...
const guards = [
  ...
  // 🔄 01.08: пункт меню «Повідомлення» зник — унизу тепер ОДНА кругла кнопка, і
  // бейдж лежить накладкою на ній. Сенс перевірки той самий, що був 30.07: число
  // не має розпирати вміст (тоді плашка з `white-space: nowrap` ширшала на кожне
  // нове повідомлення і пункт меню стрибав у розмірі).
  [/id="board-trigger"[\s\S]{0,400}?<span class="board-trigger-badge"/, BOARD_JS,
   'бейдж непрочитаних — накладка на круглій кнопці, не в тексті'],
