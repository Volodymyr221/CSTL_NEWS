...
// 🔴 18.09 — `.deploy-stamp` ЗВІДСИ ПРИБРАНО, І ЦЕ НЕ ПОСЛАБЛЕННЯ.
// Лічильник версії переїхав у бургер-меню, тобто його вже немає на екрані, поки
// меню закрите — а цей стенд міряє відгук САМЕ ВИДИМИХ елементів шапки.
// Вимір через `boundingBox()` на елементі за межами екрана брехав би в обидва боки.
// Що лічильник німий і де він має бути — стереже `tests/version-stamp-place.mjs`.
