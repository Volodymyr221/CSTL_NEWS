...
// Роль — це МОЄ / ЗАРАЗ / НОВЕ, і нічого іншого. Стара конструкція ставила сюди
// назви розділів; сторож не дає їм повернутись непомітно.
ok('🔴 підпис капсули — роль, а не назва розділу',
   caps.ролі.every(r => ['МОЄ', 'ЗАРАЗ', 'НОВЕ'].includes(r)), caps.ролі.join(',') || '—');
