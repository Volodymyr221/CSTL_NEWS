...
// ── 2-4. ЧАТ: що видно після заставки і куди веде «назад» ────────────────────
{
  ...
  ok('2в. вкладка застосунку — Дошка (там живуть повідомлення)',
     крок0.вкладка === 'board', `вкладка: ${крок0.вкладка}`);
  ...
  ok('4. другий «назад» лишає людину в застосунку на Дошці',
     !!крок2 && !крок2.екрани.length && крок2.вкладка === 'board' && крок2.таббар,
  ...
  ok('5б. після них людина досі в застосунку, на Дошці',
     !!хвіст && хвіст.таббар && хвіст.вкладка === 'board',
