...
// 🔴 «перевірок пройдено» — НЕ прикраса. `tests/run.mjs` шукає рівно цей рядок
// (`/(\d+)\/(\d+) перевірок пройдено/`), щоб зарахувати перевірки в загальний
// підсумок. Без цих двох слів стенд ПРОХОДИВ (код виходу 0), а прогін малював
// проти нього «💥 впав, не дійшовши до підсумку» і мовчки НЕ рахував його
// 6 перевірок. Спіймано 15.08.2026 — через це власнику назвали неповне число.
