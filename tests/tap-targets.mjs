...
//
// ➡️ СУСІДНІЙ СТОРОЖ: `tests/tap-targets-hig.mjs` (04.09) міряє тим самим
// `elementFromPoint` сім елементів шапки, Стрічки й Дошки — але з ЦІЛЛЮ 44×44,
// бо там місце є. Тут ціль інша й нижча НАВМИСНО (див. абзац «чесно про 44×44»
// вище). Правиш один — глянь в інший, критерії різні не випадково.
//
