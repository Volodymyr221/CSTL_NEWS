...
ok('5д. відповіді намальовані (5 з фікстури: 2 кореневі + 3 вкладені)',
   !!screen && screen.відповідей === 5, screen ? `${screen.відповідей}` : '—');
ok('5е. вкладені відповіді показані з відступом, а не цитатою в бульбашці',
   !!screen && screen.вкладених === 3, screen ? `вкладених=${screen.вкладених}` : '—');
