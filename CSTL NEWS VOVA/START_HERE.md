...
**🟢 Найгостріше зараз — критичного нема.** Закрито 26.07: живий тест коментарів (СТ-2),
створення спільнот з адмінки (СИ-9), фото-пуш у чаті (B-24), клавіатура у встановленому
додатку, комплексна обробка мережевих збоїв.

**Що обговорюється:** глибина вкладеності відповідей у коментарях — зараз 2 рівні (як
Instagram), Вова показав зразок Facebook із 3 рівнями. Рішення не прийнято.
