...
**🔴 Найгостріше зараз:**
1. **B-24** — `send-chat-push` не задеплоєна: фото у приватному чаті **не доставляє сповіщення**
   (фікс лежить у репо 15 днів, деплоїться за хвилину через Supabase MCP).
2. **B-23** — дірка `pcom update`: можна підробити авторство коментаря і **обійти каскадне
   видалення**. Рішення Вови ще не отримано.
3. **Живий тест** усього блоку коментарів на телефоні — Вова ще нічого не бачив наживо.
