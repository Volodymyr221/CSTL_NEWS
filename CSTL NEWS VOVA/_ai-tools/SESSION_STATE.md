...
**Оновлено:** 2026-05-20 (Додано окремий лендинг `transport-site/` — натхненний parktrans.com.ua, але з власним брендом «ВантажХаб», темно-синім+бурштиновим дизайном і власною структурою. Не пов'язано з основним сайтом CSTL LIFE, живе в окремій папці.)
...
| **CACHE_NAME у `sw.js`** | `cstl-20260520-1807` (оновити при наступній зміні коду) |
