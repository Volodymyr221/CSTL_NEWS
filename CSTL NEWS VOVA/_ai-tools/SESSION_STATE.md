...
### Сесія 2 (08.04.2026)
- Червоний ободок (border) для карток з міткою «ЕКСКЛЮЗИВ» — 2px, колір `--red`
- Виправлено баг: `renderFeatured()` не додавав клас `exclusive` на featured-картку
- Додано виведення `excerpt` (першого речення статті) під заголовком у всіх картках
- CACHE_NAME оновлено → `cstl-20260408-1915`
