...
**Оновлено:** 2026-06-07 (Автобуси: повні зупинки 6 маршрутів з реальними км+ціна)
...
**Last commit (останній коміт):** `84d6c47` — `feat(buses): повні зупинки для всіх 6 маршрутів з реальними км та цінами`
