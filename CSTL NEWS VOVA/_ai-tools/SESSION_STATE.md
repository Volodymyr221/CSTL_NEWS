...
**Оновлено:** 2026-05-18 (після `1c3b7c9` + `0552b53`: автобус-блок Громади у табло-стилі + 2 нові таби адмінки — Опубліковані пости і Коментарі)
...
1. **Той самий табло-стиль для Подій / Світла** — узгодженість дизайну (на Громаді і Автобусах уже застосовано).
2. **Фаза 9 Спринт 2** — Supabase Storage + upload фото з форми (зараз фото зберігаються як base64 — текст у БД, важко і повільно).
