...
**Оновлено:** 2026-05-18 (табло-стиль для блоку Громади «Найближча подія» + дизайн-токени `.tablo-*` / `.evh-*` у base.css. Hero на вкладці Подій прибрано — дублював перший елемент списку)
...
| **CACHE_NAME у `sw.js`** | `cstl-20260518-1558` (оновити при наступній зміні коду) |
