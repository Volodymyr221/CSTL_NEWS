...
**Оновлено:** 2026-05-18 (табло-стиль на Подіях: дизайн-токени `.tablo-*` у base.css, hero «Найближча подія» з countdown капсулою, блок Громади `cm-block--event` рідизайнено у тому ж стилі)
...
| **CACHE_NAME у `sw.js`** | `cstl-20260518-1527` (оновити при наступній зміні коду) |
