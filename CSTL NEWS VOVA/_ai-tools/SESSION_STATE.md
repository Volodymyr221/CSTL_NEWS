...
**Оновлено:** 2026-05-17 (Дошка громади 2.0 UI на DEMO-даних — таби, 3 типи карток, пошук, реакції, збережені, submit з вибором типу. Готова до підключення Supabase коли буде ключ)
...
- **Реакції** ❤️👍😂😢 — клік перемикає, зберігається у `localStorage['cstl-reactions-v1']`
- **Збережені** 💾 — кнопка-закладка на кожній картці → таб «Мої»
