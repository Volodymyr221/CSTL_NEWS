...
**Оновлено:** 2026-06-07 (Автобуси: 14-денний календар, свайп тижнів, фільтр маршрутів, стиль активного дня)
...
| **CACHE_NAME у `sw.js`** | `cstl-20260607-0018` |
...
**Last commit (останній коміт):** `4c2dab9` — `style(buses): today+active — same fill/blur as others, only border stays red`
