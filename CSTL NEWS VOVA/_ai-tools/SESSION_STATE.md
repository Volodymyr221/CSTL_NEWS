...
**Оновлено:** 2026-05-18 (Автобуси v3: 3 стани шкали — waiting/enroute/past, маршрутна шкала з маркером 🚌 і зупинками, спільний модуль `src/core/bus-schedule.js`)
...
| **CACHE_NAME у `sw.js`** | `cstl-20260518-1626` (оновити при наступній зміні коду) |
