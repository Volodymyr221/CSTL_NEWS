...
**Оновлено:** 2026-05-18 (Фаза 9 Спринт 2: фото з форми «Подати оголошення» тепер завантажуються у Supabase Storage bucket `community-photos` замість base64 у БД)
...
| **CACHE_NAME у `sw.js`** | `cstl-20260518-2035` (оновити при наступній зміні коду) |
