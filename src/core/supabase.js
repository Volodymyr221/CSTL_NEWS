...
//
// Стало: SVG. Форма — **зубчасте коло**, той самий силует, що в Twitter/Meta:
// він упізнається як позначка верифікації ще до того, як людина роздивиться
// галочку всередині. Сама галочка — векторний шлях, а не текст, тож її товщина
// однакова скрізь і не залежить від шрифту.
// 📐 Зубці пораховані, не намальовані на око: 12 зубців, зовнішній радіус 11,
// внутрішній 9.1 при полі 24×24. Менша різниця радіусів робить край схожим на
// брудне коло, більша — на шестерню.
...
export function officialMarkHtml() {
  return '<span class="cstl-verified" role="img" aria-label="Офіційний акаунт" title="Офіційний акаунт">'
    ...
    + '<path class="cstl-verified-bg" d="M12.00 1.00 L14.36 3.21 L17.50 2.47 L18.43 5.57 L21.53 6.50 L20.79 9.64 L23.00 12.00 L20.79 14.36 L21.53 17.50 L18.43 18.43 L17.50 21.53 L14.36 20.79 L12.00 23.00 L9.64 20.79 L6.50 21.53 L5.57 18.43 L2.47 17.50 L3.21 14.36 L1.00 12.00 L3.21 9.64 L2.47 6.50 L5.57 5.57 L6.50 2.47 L9.64 3.21Z"/>'
    + '<path class="cstl-verified-tick" d="M10.6 16.2 L6.8 12.4 L8.4 10.8 L10.6 13.0 L15.6 8.0 L17.2 9.6 Z"/>'
    + '</svg></span>';
}
