...
export async function openThreadById(threadId) {
  ...
  //
  // Лікуємо трьома кроками, і всі три потрібні:
  ...
  //   3) вкладку ставимо на Дошку — звідти в застосунку живуть повідомлення,
  //      тож коли обидва екрани закриються, людина стоїть у правильному місці.
