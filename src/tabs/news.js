...
// Тихий рядок: заголовок і час. Без фото, без джерела, без опису — усе це вже
// сказала велика картка над ним, а рядок тут для ОБСЯГУ («є ще про що почитати»),
// а не для повторного показу тієї самої інформації.
