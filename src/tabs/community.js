...
function renderSkeleton() {
  ...
  el.innerHTML = `
    ...
    <!-- 🔴 ЧОМУ САМЕ day-2, А НЕ day-1 (04.08, скарга Вови «фото розтягнуте»).
         Це питання ФОРМАТУ, не налаштувань. Екран телефона вертикальний
         (390×844 CSS = 1170×2532 реальних пікселів при DPR 3), а olyka.day-1
         має 1440×810 — горизонтальний кадр 16:9. Щоб таким фото закрити
         ...
         olyka.day-2 має 1167×1347 (майже квадрат) → розтяг 1.9 раза замість
         3.1, обрізається 47% замість 74%.
         ⚠️ ТИМЧАСОВЕ РІШЕННЯ. Правильне — вертикальне фото 9:16 щонайменше
         1440×2560; технічні вимоги до нього Вова замовляє окремо. -->
