...
//
// 🗓 СЕКЦІЯ «ПОДІЇ ГРОМАДИ» ПОВЕРНУЛАСЬ 04.09 — і це свідомий відкат рішення
// 04.08 («події прибрати»). Тодішня причина була НЕ в даних, а в тому, що
// вести з блока не було куди: вкладки Подій не існує, а кнопка вела у Стрічку.
// ✅ Тепер подія — це ДОПИС спільноти, тож тап відкриває саме її; і джерело
// стало те саме, що у Стрічці, замість протухлого `data/events.json`.
//
// ─────────────────────────────────────────────────────────────────────────────
...
function renderSkeleton() {
  ...
  el.innerHTML = `
    ...
    <!-- ══ ПОДІЇ ГРОМАДИ ═══════════════════════════════════════════════════════
         🆕 04.09 — СЕКЦІЮ ПОВЕРНУТО, і це усвідомлений відкат рішення 04.08.
         🗣️ Тоді Вова сказав «події прибрати», і причина була не в даних:
         «вести з неї не було куди — вкладки Подій не існує, кнопка вела у
         Стрічку». ✅ Сьогодні причина зникла: подія — це ДОПИС спільноти, тож
         тап відкриває саме її, а не абстрактну «афішу».
