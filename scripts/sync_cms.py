...
def fetch_community_to_news():
    ...
    try:
        ...
        print(f"  ⚠ дописи спільнот не прочитались ({e}) — синк статей це не спиняє")
        return []
...
def sync_community_posts(existing, seen_by_section, next_id):
    """Додає дописи з `to_news` у стрічку. Повертає (нові_статті, наступний_id).
    ...
    нові = []
    for row in fetch_community_to_news():
...
def main():
    ...
    дописи, next_id = sync_community_posts(existing, seen_by_section, next_id)
