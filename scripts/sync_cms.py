...
def заголовок_допису(text: str) -> str:
    ...
    🔑 У допису НЕМАЄ поля заголовка — це пост, а не стаття. Беремо перше речення
    і ріжемо по межі слова: обрізане на півслові виглядало б як зламані дані, а не
    як стислий підпис.
    """
