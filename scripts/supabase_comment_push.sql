...
--
-- ✅ НАКАТАНО 25.07.2026 (Вова, вручну через Supabase → SQL Editor).
--    Перевірено: колонка · тригер · добіг pg_cron · секрет — усі на місці (1·1·1·1).
--    Цей файл — джерело правди на випадок відновлення. Ідемпотентний.
--
