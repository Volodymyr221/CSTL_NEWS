...
--    середовища. Накатати: Supabase → SQL Editor → вставити цей файл → Run.
--    ⚠️ Накатувати ПІСЛЯ `scripts/supabase_reject_reason.sql` — той заводить
--    колонку причини і тригер, який стирає її при зміні статусу.
--
